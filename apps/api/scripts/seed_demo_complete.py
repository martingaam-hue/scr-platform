...
BUDGET_ITEMS = {
    "helios-solar-portfolio-iberia": [
        ("EPC & Equipment", "Solar panels, inverters, trackers, BOS", Decimal("218000000"), Decimal("218000000"), "EUR", BudgetItemStatus.COMPLETED),
        ("Grid Connection & Substation", "Grid connection costs across 6 plants", Decimal("18500000"), Decimal("18200000"), "EUR", BudgetItemStatus.COMPLETED),
        ("Land Lease (prepaid)", "25-year land lease payments capitalised", Decimal("12000000"), Decimal("12000000"), "EUR", BudgetItemStatus.COMPLETED),
        ("Development & Permitting", "Environmental permits, planning, legal", Decimal("8500000"), Decimal("8300000"), "EUR", BudgetItemStatus.COMPLETED),
        ("Debt Arrangement Fees", "Facility agent, legal, modelling", Decimal("4200000"), Decimal("4200000"), "EUR", BudgetItemStatus.COMPLETED),
        ("Debt Service Reserve", "6 months DSRA funded at financial close", Decimal("13900000"), Decimal("13900000"), "EUR", BudgetItemStatus.COMPLETED),
        ("O&M Reserve", "Initial O&M reserve account funding", Decimal("2500000"), Decimal("2500000"), "EUR", BudgetItemStatus.COMPLETED),
        ("Snag-List Retention (Córdoba)", "Retained pending snag list completion", Decimal("1200000"), None, "EUR", BudgetItemStatus.IN_PROGRESS),
    ],
    "nordvik-wind-farm-ii": [
        ("EPC Contract (Vestas/Skanska JV)", "Fixed-price EPC including nacelles and installation", Decimal("302000000"), Decimal("257700000"), "EUR", BudgetItemStatus.IN_PROGRESS),
        ("Turbine Supply (35 × V162)", "Vestas nacelle supply and 10yr service contract", Decimal("168000000"), Decimal("148000000"), "EUR", BudgetItemStatus.IN_PROGRESS),
        ("Grid & Substation (Internal)", "Internal 66kV grid and substation", Decimal("42000000"), Decimal("27300000"), "EUR", BudgetItemStatus.IN_PROGRESS),
        ("Access Roads & Civil Works", "Site roads, laydown areas, foundations", Decimal("28000000"), Decimal("28000000"), "EUR", BudgetItemStatus.COMPLETED),
        ("Environmental & Permitting", "NVE licence, environmental studies, Sámi consultation", Decimal("5500000"), Decimal("5500000"), "EUR", BudgetItemStatus.COMPLETED),
        ("Development & Finance Costs", "Advisor, modelling, legal, arrangement fees", Decimal("12500000"), Decimal("12500000"), "EUR", BudgetItemStatus.COMPLETED),
        ("Construction Contingency", "7.5% contingency reserve", Decimal("30500000"), Decimal("7000000"), "EUR", BudgetItemStatus.IN_PROGRESS),
        ("Construction Insurance (CAR)", "Construction all-risk policy (Swiss Re)", Decimal("3200000"), Decimal("3200000"), "EUR", BudgetItemStatus.COMPLETED),
    ],
    "adriatic-infrastructure-holdings": [
        ("Motorway Acquisition (Istria A-9)", "Equity purchase of toll road concession", Decimal("105000000"), Decimal("105000000"), "EUR", BudgetItemStatus.COMPLETED),
        ("Water Utility Acquisition (Primorska)", "Equity purchase of water utility", Decimal("85000000"), Decimal("85000000"), "EUR", BudgetItemStatus.COMPLETED),
        ("District Energy Acquisition (Ljubljana)", "Equity purchase of district heating", Decimal("75000000"), Decimal("75000000"), "EUR", BudgetItemStatus.COMPLETED),
        ("Transaction Costs", "Legal, advisory, due diligence (PwC, Steer)", Decimal("14500000"), Decimal("14500000"), "EUR", BudgetItemStatus.COMPLETED),
        ("Primorska Voda CapEx Programme", "Network renewal, NRW reduction 5yr programme", Decimal("45000000"), Decimal("12000000"), "EUR", BudgetItemStatus.IN_PROGRESS),
...
SEVERITY_MAP = {"green": RiskAssessmentStatus.MONITORED, "amber": RiskAssessmentStatus.IDENTIFIED, "red": RiskAssessmentStatus.IDENTIFIED}
        ...
        for risk_id, rtype, sev, prob, desc, mitigation, colour in risks:
            ...
            if not dry_run:
                r = RiskAssessment(
                    ...
                    technology_risk_score=SCORE_MAP[colour] if rtype == RiskType.TECHNOLOGY else None,
