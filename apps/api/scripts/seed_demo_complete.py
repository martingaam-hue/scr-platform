...
PROJECTS = [
    {
        ...
        "technology_details": {
            ...
            "plants": [
                {
                    "name": "Helios Almería I",
                    "location": "Tabernas, Andalucía",
                    "mwp": 85,
                    "cod": "2024-02-10",
                    "p50_gwh": 161.5,
                    "grid": "REE 132 kV",
                ...
                {
                    "name": "Helios Almería II",
                    "location": "Níjar, Andalucía",
                    "mwp": 70,
                    "cod": "2024-03-22",
                    "p50_gwh": 129.5,
                    "grid": "REE 132 kV",
                ...
                {
                    "name": "Helios Ciudad Real",
                    "location": "Puertollano, CLM",
                    "mwp": 65,
                    "cod": "2024-05-02",
                    "p50_gwh": 117.0,
                    "grid": "REE 132 kV",
            ...
            "revenue_structure": [
                {
                    ...
                    "tenor_end": "2034",
                    "price_eur_mwh": 42.50,
                    "escalation": "CPI-linked (floor 1.5%)",
                    "credit_rating": "BBB+ (S&P)",
                },
                {
                    "type": "PPA-Fixed",
                    "counterparty": "Endesa Energía",
                    "volume_gwh_yr": 150,
                    "tenor_yr": 7,
                    "tenor_end": "2031",
                    "price_eur_mwh": 47.00,
                ...
                {
                    "type": "Merchant",
                    "counterparty": "OMIE Day-Ahead Pool",
                    "volume_gwh_yr": 338.5,
                    "tenor_yr": None,
                    "tenor_end": "Ongoing",
                    "price_eur_mwh": None,
    ...
    },
    {
        ...
        "technology_details": {
            ...
            "revenue_structure": [
                {
                    "type": "Corporate PPA",
                    "counterparty": "Norsk Hydro ASA",
                    "volume_gwh_yr": 350,
                    "tenor_yr": 12,
                    "tenor_end": "2038",
                    "price": "NOK 310/MWh (~€27.15)",
                    "escalation": "70% NOR CPI",
                    "credit_rating": "BBB+ (Fitch)",
                },
                {
                    "type": "Green Certificate (ElCert)",
                    "counterparty": "Svenska Kraftnät",
                    "volume_gwh_yr": 708,
                    "tenor_end": "2035 (phase-out)",
                    "price": "NOK 45/MWh (~€3.94)",
                    "escalation": "Market-linked",
                    "credit_rating": "Sovereign (AAA)",
                },
                {
                    "type": "Merchant",
                    "counterparty": "Nordpool Day-Ahead",
                    "volume_gwh_yr": 358,
                    "price": "Market",
                    "forward_range": "NOK 380-520",
                    "credit_rating": "N/A",
                },
            ],
            "contracted_pct": 49.0,
            ...
            "cash_flow_projection": [
                ...
                },
                {
                    ...
                    "cfads": 401,
                    "free_cash": -331,
                    "note": "Mezzanine bullet repayment — refinancing planned",
                },
            ],
        },
...
MILESTONES = {
    "helios-solar-portfolio-iberia": [
        (
            "Financial Close",
            "Senior Facility Agreement executed",
            date(2024, 8, 14),
            date(2024, 8, 14),
        ...
        (
            "Helios Almería I — COD",
            "Commercial operation of first plant (85 MWp)",
            date(2024, 2, 10),
            date(2024, 2, 10),
            MilestoneStatus.COMPLETED,
            100,
        ...
        (
            "Full Portfolio COD",
            "All 6 plants operational (420 MWp)",
            date(2024, 6, 30),
            date(2024, 6, 12),
            MilestoneStatus.COMPLETED,
            100,
        ...
        (
            "First PPA Payment",
            "Iberdrola CfD first quarterly settlement",
            date(2024, 10, 1),
            date(2024, 10, 1),
            MilestoneStatus.COMPLETED,
            100,
        ...
        (
            "Q4 2025 Monitoring Report",
            "Quarterly IC report submitted to lenders",
            date(2026, 2, 15),
            date(2026, 1, 28),
            MilestoneStatus.COMPLETED,
            100,
        ...
        (
            "Córdoba Snag-List Resolution",
            "Complete outstanding items on Córdoba plant",
            date(2026, 3, 31),
            None,
        ...
        (
            ...
            "Annual SFDR Art. 9 disclosure to investors",
            date(2026, 6, 30),
            None,
        ...
        (
            "PPA-2 Renewal Strategy",
            "Term sheet options for Endesa PPA renewal",
            date(2026, 6, 30),
            None,
            MilestoneStatus.IN_PROGRESS,
            20,
        ...
        (
            "Insurance Renewal",
            "Allianz policy renewal (expires Jan 2027)",
            date(2026, 10, 1),
            None,
            MilestoneStatus.NOT_STARTED,
            0,
    ...
    "nordvik-wind-farm-ii": [
        (
            "Financial Close",
            "Senior and mezzanine facilities executed",
            date(2025, 3, 20),
            date(2025, 3, 20),
            MilestoneStatus.COMPLETED,
            100,
        ...
        (
            "Site Access Roads",
            "Access road construction complete",
            date(2025, 4, 30),
            date(2025, 5, 8),
            MilestoneStatus.COMPLETED,
            100,
        ...
        (
            "Foundation Pours (35/35)",
            "All 35 turbine foundations poured",
            date(2025, 9, 30),
            date(2025, 10, 12),
            MilestoneStatus.COMPLETED,
            100,
        ...
        (
            "Turbine Erection (35/35)",
            "All 35 turbines erected (28/35 complete)",
            date(2026, 6, 30),
            None,
            MilestoneStatus.IN_PROGRESS,
            80,
        ...
        (
            ...
            "HV grid and substation (65% complete)",
            date(2026, 7, 31),
            None,
            MilestoneStatus.IN_PROGRESS,
            65,
        ...
        (
            "Construction Milestone Certificate — March",
    ...
    "adriatic-infrastructure-holdings": [
        (
            "Portfolio Acquisition Close",
            "Acquisition of all 3 concessions completed",
            date(2023, 12, 15),
            date(2023, 12, 15),
            MilestoneStatus.COMPLETED,
            100,
        ...
        (
            "Post-Acquisition 100-Day Review",
            "Operational handover and integration",
            date(2024, 3, 31),
            date(2024, 4, 5),
            MilestoneStatus.COMPLETED,
            100,
        ...
        (
            "NRW Reduction Programme Launch",
            "Primorska Voda network improvement kickoff",
            date(2024, 6, 1),
            date(2024, 6, 1),
            MilestoneStatus.COMPLETED,
            100,
        ...
        (
            "Annual Valuation (2025)",
            "External portfolio valuation completed",
            date(2026, 1, 30),
            date(2026, 1, 30),
            MilestoneStatus.COMPLETED,
            100,
        ...
        (
            "NRW Mid-Programme Review",
            "Progress review: target 25% by 2030",
            date(2026, 6, 30),
            None,
            MilestoneStatus.IN_PROGRESS,
            40,
        ...
        (
            ...
            "District Energy heat pump final review",
            date(2026, 9, 1),
            None,
            MilestoneStatus.IN_PROGRESS,
            35,
        ...
        (
            "Tariff Pre-Filing Strategy",
            "Primorska Voda regulatory review preparation",
            date(2027, 6, 30),
            None,
            MilestoneStatus.NOT_STARTED,
            0,
        ...
        (
            ...
            "Motorway EV infrastructure assessment",
            date(2026, 7, 31),
            None,
            MilestoneStatus.NOT_STARTED,
            0,
        ...
        (
            "Insurance Renewal (All 3 Assets)",
            "Annual insurance review across portfolio",
            date(2026, 11, 15),
            None,
            MilestoneStatus.NOT_STARTED,
            0,
...
BUDGET_ITEMS = {
    "helios-solar-portfolio-iberia": [
        (
            "EPC & Equipment",
            "Solar panels, inverters, trackers, BOS",
            Decimal("218000000"),
            Decimal("218000000"),
            "EUR",
        ...
        (
            ...
            "Grid connection costs across 6 plants",
            Decimal("18500000"),
            Decimal("18200000"),
            "EUR",
            BudgetItemStatus.PAID,
        ...
        (
            "Land Lease (prepaid)",
            "25-year land lease payments capitalised",
            Decimal("12000000"),
            Decimal("12000000"),
            "EUR",
            BudgetItemStatus.PAID,
        ...
        (
            ...
            "Environmental permits, planning, legal",
            Decimal("8500000"),
            Decimal("8300000"),
            "EUR",
            BudgetItemStatus.PAID,
        ...
        (
            ...
            "Facility agent, legal, modelling",
            Decimal("4200000"),
            Decimal("4200000"),
            "EUR",
            BudgetItemStatus.PAID,
        ...
        (
            ...
            "6 months DSRA funded at financial close",
            Decimal("13900000"),
            Decimal("13900000"),
            "EUR",
            BudgetItemStatus.PAID,
        ...
        (
            "O&M Reserve",
            "Initial O&M reserve account funding",
            Decimal("2500000"),
            Decimal("2500000"),
            "EUR",
            BudgetItemStatus.PAID,
        ...
        (
            "Snag-List Retention (Córdoba)",
            "Retained pending snag list completion",
            Decimal("1200000"),
            None,
            "EUR",
    ...
    "nordvik-wind-farm-ii": [
        (
            "EPC Contract (Vestas/Skanska JV)",
            "Fixed-price EPC including nacelles and installation",
            Decimal("302000000"),
            Decimal("257700000"),
            "EUR",
            BudgetItemStatus.COMMITTED,
        ...
        (
            "Turbine Supply (35 × V162)",
            "Vestas nacelle supply and 10yr service contract",
            Decimal("168000000"),
            Decimal("148000000"),
            "EUR",
            BudgetItemStatus.COMMITTED,
        ...
        (
            "Grid & Substation (Internal)",
            "Internal 66kV grid and substation",
            Decimal("42000000"),
            Decimal("27300000"),
            "EUR",
            BudgetItemStatus.COMMITTED,
        ...
        (
            "Access Roads & Civil Works",
            "Site roads, laydown areas, foundations",
            Decimal("28000000"),
            Decimal("28000000"),
            "EUR",
            BudgetItemStatus.PAID,
        ...
        (
            ...
            "NVE licence, environmental studies, Sámi consultation",
            Decimal("5500000"),
            Decimal("5500000"),
            "EUR",
            BudgetItemStatus.PAID,
        ...
        (
            ...
            "Advisor, modelling, legal, arrangement fees",
            Decimal("12500000"),
            Decimal("12500000"),
            "EUR",
            BudgetItemStatus.PAID,
        ...
        (
            ...
            "Construction all-risk policy (Swiss Re)",
            Decimal("3200000"),
            Decimal("3200000"),
            "EUR",
            BudgetItemStatus.PAID,
    ...
    "adriatic-infrastructure-holdings": [
        (
            "Motorway Acquisition (Istria A-9)",
            "Equity purchase of toll road concession",
            Decimal("105000000"),
            Decimal("105000000"),
            "EUR",
            BudgetItemStatus.PAID,
        ...
        (
            "Water Utility Acquisition (Primorska)",
            "Equity purchase of water utility",
            Decimal("85000000"),
            Decimal("85000000"),
            "EUR",
            BudgetItemStatus.PAID,
        ...
        (
            "District Energy Acquisition (Ljubljana)",
            "Equity purchase of district heating",
            Decimal("75000000"),
            Decimal("75000000"),
            "EUR",
            BudgetItemStatus.PAID,
        ...
        (
            "Transaction Costs",
            "Legal, advisory, due diligence (PwC, Steer)",
            Decimal("14500000"),
            Decimal("14500000"),
            "EUR",
            BudgetItemStatus.PAID,
        ...
        (
            "Primorska Voda CapEx Programme",
            "Network renewal, NRW reduction 5yr programme",
            Decimal("45000000"),
            Decimal("12000000"),
            "EUR",
            BudgetItemStatus.COMMITTED,
        ...
        (
            "Ljubljana Heat Pump Integration",
            "Heat pump & geothermal (2027-2029)",
            Decimal("32000000"),
            Decimal("0"),
            "EUR",
        ...
        (
            "Motorway EV Charging Roll-out",
            "EV charging stations (post-feasibility)",
            Decimal("8000000"),
            None,
            "EUR",
            BudgetItemStatus.PLANNED,
...
RISKS = {
    "helios-solar-portfolio-iberia": [
        (
            ...
            "56% contracted; hedging strategy for yr 2–3 merchant tail",
            "amber",
        ),
        (
            "R-002",
            ...
            "DNV-verified P50/P90 reports; bifacial gain buffer",
            "green",
        ),
        (
            "R-003",
            ...
            "Portfolio diversification across 3 autonomous communities",
            "amber",
        ),
        (
            "R-004",
            ...
            "Huawei SUN2000 5yr warranty + extended service agreement",
            "green",
        ),
        (
            "R-005",
            ...
            "Step-in rights; replacement PPA trigger at BB+",
            "green",
        ),
        (
            "R-006",
            ...
            "€1.2M retention held; 95% complete",
            "green",
        ),
        (
            "R-007",
            ...
            "Natural hedge via EUR revenues; minor exposure",
            "green",
        ),
    ],
    "nordvik-wind-farm-ii": [
        (
            ...
            "Schedule buffer; Arctic-rated equipment; heated concrete",
            "amber",
        ),
        (
            "R-102",
            ...
            "28/35 delivered; remaining 7 in transit (ETA Apr 2026)",
            "green",
        ),
        (
            "R-103",
            ...
            "Geotech survey complete; additional blasting budget approved",
            "amber",
        ),
        (
            "R-104",
            ...
            "NOK-denominated debt; natural hedge on revenue",
            "green",
        ),
        (
            "R-105",
            ...
            "PPA floor price covers debt service without ElCerts",
            "green",
        ),
        (
            "R-106",
            ...
            "Seasonal halt (Apr 15–May 30); Sámi council agreement signed",
            "green",
        ),
        (
            "R-107",
            ...
            "Cross-default clause; parent guarantee (Norsk Hydro ASA)",
            "green",
        ),
        (
            "R-108",
            ...
            "Fixed-price EPC with Vestas/Skanska JV; contingency 22% used",
            "green",
        ),
    ],
    "adriatic-infrastructure-holdings": [
        (
            ...
            "Engaged regulatory advisor; pre-filing strategy Q3 2027",
            "red",
        ),
        (
            "R-202",
            ...
            "Summer traffic buffer; 80% CPI toll escalation",
            "amber",
        ),
        (
            "R-203",
            ...
            "Concession protected by bilateral investment treaty",
            "green",
        ),
        (
            "R-204",
            ...
            "Dedicated PMO; milestone-linked contractor payments",
            "amber",
        ),
        (
            "R-205",
            ...
            "Biomass switching capacity; 70% pass-through in tariff",
            "amber",
        ),
        (
            "R-206",
            ...
            "Fixed-price heat pump contract; €5M contingency",
            "amber",
        ),
        (
            "R-207",
            ...
            "Eliminated — Croatia adopted EUR Jan 2023",
            "green",
        ),
        (
            "R-208",
            ...
            "Supplier audit programme; 2 certified alternates identified",
            "green",
        ),
        (
            "R-209",
            ...
            "15yr take-or-pay contract; sovereign-adjacent counterparty",
            "green",
        ),
    ],
}
...
SEVERITY_MAP = {
    "green": RiskAssessmentStatus.MONITORING,
    "amber": RiskAssessmentStatus.IDENTIFIED,
    "red": RiskAssessmentStatus.IDENTIFIED,
}
SCORE_MAP = {"red": Decimal("8.0"), "amber": Decimal("5.0"), "green": Decimal("2.5")}


def seed_risks(
    session: Session, project_ids: dict, org_id: uuid.UUID, user_id: uuid.UUID, dry_run: bool
):
        ...
        for risk_id, rtype, sev, prob, desc, mitigation, colour in risks:
            ...
            if not dry_run:
                r = RiskAssessment(
                    ...
                    regulatory_risk_score=SCORE_MAP[colour]
                    if rtype == RiskType.REGULATORY
                    else None,
                    climate_risk_score=SCORE_MAP[colour] if rtype == RiskType.CLIMATE else None,
                    technology_risk_score=SCORE_MAP[colour]
                    if rtype == RiskType.OPERATIONAL
                    else None,
...
COVENANTS = {
    ...
    "adriatic-infrastructure-holdings": [
        ...
        (
            "Concession Compliance (all 3)",
            "milestone",
            "concessions_certified",
            "==",
            3.0,
            3.0,
            "compliant",
...
DOCUMENTS = {
    "helios-solar-portfolio-iberia": [
        ...
        (
            "Independent Technical Assessment (DNV)",
            "Due Diligence",
            "Confidential",
            date(2024, 6, 1),
            "pdf",
        ...
        (
            "Yield Assessment Report — P50/P90 (DNV)",
            "Due Diligence",
            "Confidential",
            date(2024, 5, 15),
            "pdf",
        ...
        (
            "PPA-1 Executed Agreement (Iberdrola)",
            "Legal",
        ...
        (
            "PPA-2 Executed Agreement (Endesa)",
            "Legal",
            "StrictlyConfidential",
            date(2024, 8, 10),
            "pdf",
    ...
    "nordvik-wind-farm-ii": [
        ...
        (
            "Independent Engineer Report (DNV)",
            "Due Diligence",
            "Confidential",
            date(2025, 1, 20),
            "pdf",
        ...
        (
            "Wind Resource Assessment (Vortex/WindSim)",
            "Due Diligence",
            "Confidential",
            date(2024, 11, 15),
            "pdf",
        ...
        (
            "Senior Facility Agreement (DNB/Nordea)",
            "Legal",
            "StrictlyConfidential",
            date(2025, 3, 20),
            "pdf",
        ...
        (
            "Sámi Council Co-existence Agreement",
            "ESG / Social",
            "Internal",
            date(2024, 6, 22),
            "pdf",
        ...
        (
            "Monthly Construction Report #11 (Feb 2026)",
            "Monitoring",
            "Internal",
            date(2026, 2, 15),
            "pdf",
    ...
    "adriatic-infrastructure-holdings": [
        ...
        (
            "Consolidated Due Diligence Report (PwC)",
            "Due Diligence",
            "Confidential",
            date(2023, 10, 1),
            "pdf",
        ...
        (
            "Traffic Study — Istria Motorway (Steer)",
            "Due Diligence",
            "Confidential",
            date(2023, 9, 15),
            "pdf",
        ...
        (
            "Water Utility Technical Assessment (Mott MacDonald)",
            "Due Diligence",
            "Confidential",
            date(2023, 9, 20),
            "pdf",
        ...
        (
            "District Energy Decarbonisation Plan",
            "Technical",
            "Internal",
            date(2023, 10, 10),
            "pdf",
        ...
        (
            "Concession Agreement — Istria Motorway",
            "Legal",
            "StrictlyConfidential",
            date(2012, 6, 30),
            "pdf",
        ...
        (
            "Concession Agreement — Primorska Voda",
            "Legal",
            "StrictlyConfidential",
            date(2018, 3, 15),
            "pdf",
        ...
        (
            "Concession Agreement — Ljubljana District Energy",
            "Legal",
            "StrictlyConfidential",
            date(2015, 9, 1),
            "pdf",
        ...
        (
            "Senior Facility Agreement (UniCredit/Erste)",
            "Legal",
            "StrictlyConfidential",
            date(2023, 12, 14),
            "pdf",
        ...
        (
            "Croatian Water Regulatory Framework Analysis",
            "Regulatory",
            "Internal",
            date(2025, 8, 15),
            "pdf",
...
def seed_cashflow_pacing(
    session: Session, portfolio_id: uuid.UUID, org_id: uuid.UUID, dry_run: bool
):
    existing = session.execute(
    ...
    session.flush()
    print("  [+] Cashflow assumption + projections seeded (3 scenarios, 8 years)")
...
MARKET_DATA_POINTS = [
    ...
    (
        "ember",
        "CARB_INTENSITY_EU",
        "EU Power Sector Carbon Intensity",
        date(2026, 3, 1),
        215.0,
        "gco2_per_kwh",
    ),
    ...
    (
        "eia",
        "ELEC.CONS_TOT.ALL-EU-99.A",
        "EU Total Electricity Consumption",
        date(2025, 12, 31),
        3218.5,
        "twh",
    ),
    ...
    (
        "openweather",
        "WIND_MADRID",
        "Wind Speed — Madrid (Helios proxy)",
        date(2026, 3, 1),
        4.2,
        "m_per_s",
    ),
    ...
    (
        "openweather",
        "WIND_TRONDHEIM",
        "Wind Speed — Trondheim (Nordvik proxy)",
        date(2026, 3, 1),
        7.8,
        "m_per_s",
    ),
...
CONNECTOR_CATALOG = [
    ...
    (
        ...
        "free",
        60,
        "https://ember-climate.org/data/apis/",
    ),
    (
        "eia",
        "EIA (US Energy Info Admin)",
        "energy",
        "api_key",
        "free",
        60,
        ...
        if not dry_run:
            session.add(
                OrgConnectorConfig(
                    ...
                    api_key_encrypted=api_key[:20] + "***"
                    if api_key
                    else None,  # obfuscated in seed
...
def main():
    ...
    parser.add_argument(
        "--dry-run", action="store_true", help="Show what would be seeded without DB writes"
    )
    parser.add_argument(
        "--wipe-extra", action="store_true", help="Delete augmented data before re-seeding"
    )
