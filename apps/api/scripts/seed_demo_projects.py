...
def seed_helios(
    ...
    if not dry_run:
        ...
        budget = [
            (
                "EPC / Construction",
                "6 plants construction and installation",
                Decimal("270000000"),
                Decimal("270000000"),
            ...
            (
                "Financing Costs",
                "Arrangement fees, hedging, legal",
                Decimal("12000000"),
                Decimal("11800000"),
                BudgetItemStatus.PAID,
            ),
            (
                ...
                "6-month DSRA funded at financial close",
                Decimal("13900000"),
                Decimal("13900000"),
                BudgetItemStatus.PAID,
            ),
            (
                "Working Capital",
                "O&M reserves and initial working capital",
                Decimal("1100000"),
                Decimal("1000000"),
                BudgetItemStatus.PAID,
            ),
        ...
        risks = [
            ...
            (
                ...
                "Huawei SUN2000 5-yr warranty + extended service agreement",
                RiskAssessmentStatus.MONITORING,
            ),
            (
            ...
            session.add(
                RiskAssessment(
                    ...
                    overall_risk_score=Decimal(
                        ...
                        else ("55" if sev == RiskSeverity.MEDIUM else "72")
                    ),
        ...
        for name, ctype, metric, threshold, comparison, current, status in covenants:
            session.add(
                Covenant(
                    ...
                    last_checked_at=datetime(2026, 1, 28, tzinfo=UTC),
                )
            )
        ...
        docs = [
            ...
            (
                ...
                DocumentClassification.TECHNICAL_STUDY,
                "Due Diligence",
                "2024-06-01",
            ),
            (
                "Yield Assessment Report (DNV) P50/P90",
                DocumentClassification.TECHNICAL_STUDY,
                "Due Diligence",
                "2024-05-15",
            ),
            (
                ...
                DocumentClassification.LEGAL_AGREEMENT,
                "Legal",
                "2024-08-10",
            ),
            (
            ...
            (
                ...
                DocumentClassification.ENVIRONMENTAL_REPORT,
                "Permit",
                "2023-11-20",
            ),
            (
                "Insurance Certificate (Allianz)",
                DocumentClassification.INSURANCE,
                "Insurance",
                "2025-01-15",
            ),
            (
            ...
            (
                "Annual Valuation Report 2025",
                DocumentClassification.VALUATION,
                "Valuation",
                "2026-02-15",
            ),
            (
            ...
            session.add(
                Document(
                    ...
                    metadata_={
                        ...
                        if "Agreement" in doc_name or "Memo" in doc_name
                        else "Internal",
                    },
                    uploaded_by=user_id,
...
def seed_nordvik(
    ...
    if not dry_run:
        ...
        # ── Budget Items ───────────────────────────────────────────────────────
        Decimal("4680000000")  # NOK 4.68bn
        budget = [
            (
                "EPC Contract (Vestas/Skanska JV)",
                "Fixed-price EPC for all 35 turbines",
                Decimal("3510000000"),
                Decimal("2857000000"),
            ...
            (
                "Development & Advisory",
                "Pre-construction development, permits, advisory",
                Decimal("280000000"),
                Decimal("280000000"),
                BudgetItemStatus.PAID,
            ),
            (
                ...
                "132 kV substation and grid connection",
                Decimal("540000000"),
                Decimal("350000000"),
                BudgetItemStatus.COMMITTED,
            ),
            (
                ...
                "Insurance, permits, 7.5% contingency (NOK 351M)",
                Decimal("350000000"),
                Decimal("323000000"),
                BudgetItemStatus.COMMITTED,
            ),
        ...
        risks = [
            (
                ...
                "Schedule buffer; Arctic-rated equipment; heated concrete pours",
                RiskAssessmentStatus.MONITORING,
            ),
            (
                RiskType.OPERATIONAL,
            ...
            (
                ...
                "NOK-denominated debt; natural hedge on NOK revenues",
                RiskAssessmentStatus.MONITORING,
            ),
            (
                RiskType.REGULATORY,
            ...
            (
                ...
                "Cross-default clause; Norsk Hydro parent guarantee",
                RiskAssessmentStatus.MONITORING,
            ),
        ]
        for rt, sev, prob, desc, mitigation, status in risks:
        ...
        covenants = [
            (
                ...
                "operational_kpi",
                "construction_budget_nok_spent_pct",
                100,
                "<=",
                81.4,
                "compliant",
            ...
            (
                "Contingency Drawdown Reporting",
                "operational_kpi",
            ...
            (
                "Monthly Construction Milestone Certificate",
                "reporting_deadline",
                "milestone_cert_days",
                30,
                "<=",
        ...
        for name, ctype, metric, threshold, comparison, current, status in covenants:
            session.add(
                Covenant(
                    ...
                    last_checked_at=datetime(2026, 2, 15, tzinfo=UTC),
                )
            )
        ...
        docs = [
            ...
            (
                "NVE Concession & Environmental Permit",
                DocumentClassification.PERMIT,
                "Permit",
                "2023-09-10",
            ),
            (
            ...
            (
                "Monthly Construction Report #11",
                DocumentClassification.FINANCIAL_STATEMENT,
                "Monitoring",
                "2026-02-15",
            ),
    ...
    if not dry_run:
        proj = Project(
            ...
            technology_details={
                "sub_assets": [
                    {
                        "name": "Istria Motorway A-9",
                        "type": "toll_road",
                        "concession_end": "2048",
                        "annual_revenue_eur": 38500000,
                    },
                    {
                        "name": "Primorska Voda",
                        "type": "water_utility",
                        "concession_end": "2051",
                        "annual_revenue_eur": 22000000,
                        "watchlist": True,
                    },
                    {
            ...
            is_published=True,
            published_at=datetime(2023, 12, 15, tzinfo=UTC),
        )
        session.add(proj)
        session.flush()
        ...
        milestones = [
            ...
            (
                "Year 1 Concession Compliance Certification",
                date(2024, 12, 31),
                date(2024, 12, 20),
                MilestoneStatus.COMPLETED,
                100,
            ...
            (
                "Year 2 Concession Compliance Certification",
                date(2025, 12, 31),
                date(2025, 12, 22),
                MilestoneStatus.COMPLETED,
                100,
            ...
            (
                "NRW Reduction Programme Mid-Review",
                date(2026, 6, 30),
                None,
                MilestoneStatus.IN_PROGRESS,
                30,
            ...
            (
                "District Energy Heat Pump Procurement",
                date(2026, 9, 1),
                None,
                MilestoneStatus.IN_PROGRESS,
                40,
            ...
            (
                "⚠ Tariff Review Pre-filing Strategy (Primorska Voda)",
                date(2027, 6, 30),
                None,
                MilestoneStatus.NOT_STARTED,
                5,
        ...
        budget = [
            (
                "Acquisition (Istria Motorway)",
                "EV allocation at acquisition",
                Decimal("205000000"),
                Decimal("205000000"),
                BudgetItemStatus.PAID,
            ),
            (
                "Acquisition (Primorska Voda)",
                "EV allocation at acquisition",
                Decimal("140000000"),
                Decimal("140000000"),
                BudgetItemStatus.PAID,
            ...
            (
                "Acquisition (Ljubljana District Energy)",
                "EV allocation at acquisition",
                Decimal("140000000"),
                Decimal("140000000"),
                BudgetItemStatus.PAID,
            ...
            (
                "Advisory & Transaction Costs",
                "PwC DD, legal, advisory fees",
                Decimal("12000000"),
                Decimal("11500000"),
                BudgetItemStatus.PAID,
            ),
            (
                "Water CapEx Programme (5-yr)",
                "NRW reduction, network renewal",
                Decimal("45000000"),
                Decimal("8000000"),
                BudgetItemStatus.COMMITTED,
            ),
            (
                "District Energy — Heat Pump Investment",
                "Geothermal & heat pump integration 2027–2029",
                Decimal("32000000"),
                Decimal("0"),
        ...
        risks = [
            ...
            (
                ...
                "Engaged regulatory advisor; pre-filing strategy Q3 2027; Mott MacDonald RAB re-valuation commissioned",
                RiskAssessmentStatus.MONITORING,
            ),
            (
                RiskType.MARKET,
                ...
                "Summer traffic buffer (+45%); 80% CPI toll escalation; 1.2% downside AADT growth modelled",
                RiskAssessmentStatus.MONITORING,
            ),
            (
                RiskType.OPERATIONAL,
                ...
                "Dedicated PMO; milestone-linked contractor payments; current: 34% vs 33% target",
                RiskAssessmentStatus.MONITORING,
            ),
            (
                RiskType.MARKET,
                ...
                "Biomass switching capacity (30%); 70% pass-through in tariff structure",
                RiskAssessmentStatus.MONITORING,
            ),
            (
                RiskType.OPERATIONAL,
                ...
                "Fixed-price heat pump contract; €5M contingency earmarked",
                RiskAssessmentStatus.MONITORING,
            ),
        ]
        for rt, sev, prob, desc, mitigation, status in risks:
            session.add(
                RiskAssessment(
                    ...
                    overall_risk_score=Decimal(
                        ...
                        else ("55" if sev == RiskSeverity.HIGH else "38")
                    ),
        ...
        covenants = [
            ...
            (
                "Concession Compliance — Annual",
                "reporting_deadline",
                "concession_cert_annual",
                365,
                "<=",
                280,
                "compliant",
        ...
        for name, ctype, metric, threshold, comparison, current, status in covenants:
            session.add(
                Covenant(
                    ...
                    status=status,
                    check_frequency="quarterly",
                    last_checked_at=datetime(2026, 2, 10, tzinfo=UTC),
                )
            )
