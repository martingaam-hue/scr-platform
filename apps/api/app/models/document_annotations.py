...
class DocumentAnnotation(Base, ModelMixin):
    ...
    position: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict, server_default="{}")
    ...
    linked_citation_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), nullable=True)
