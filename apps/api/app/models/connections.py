...
class ProfessionalConnection(BaseModel):
    ...
    connected_person_name: Mapped[str | None] = mapped_column(String(200), nullable=True)
    connected_person_email: Mapped[str | None] = mapped_column(String(200), nullable=True)
...
class IntroductionRequest(BaseModel):
    ...
    target_investor_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), nullable=False)
