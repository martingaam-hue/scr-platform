...
down_revision: str | None = "cb877e7100cf"
...
def upgrade() -> None:
    ...
    _create_enum("advisoravailabilitystatus", "available", "limited", "unavailable").create(
    ...
    _create_enum("antidilutiontype", "none", "broad_based", "narrow_based", "full_ratchet").create(
        conn, checkfirst=True
    )
    ...
    _create_enum("monitoringalertseverity", "info", "warning", "critical").create(
        conn, checkfirst=True
    )
    ...
    _create_enum("insurancepremiumfrequency", "monthly", "quarterly", "annual").create(
        conn, checkfirst=True
    )
    ...
    _create_enum("insuranceside", "ally", "investor").create(conn, checkfirst=True)
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            postgresql.ENUM(
                ...
                "limited",
                "unavailable",
                name="advisoravailabilitystatus",
                create_type=False,
            ),
            nullable=False,
        ...
        sa.Column(
            ...
            postgresql.ENUM(
                ...
                "pro_bono",
                "negotiable",
                name="advisorcompensationpreference",
                create_type=False,
            ),
            nullable=False,
    ...
    op.create_index(
        "ix_board_advisor_profiles_availability", "board_advisor_profiles", ["availability_status"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            postgresql.ENUM(
                ...
                "active",
                "completed",
                name="boardadvisorapplicationstatus",
                create_type=False,
            ),
            nullable=False,
        ...
        sa.ForeignKeyConstraint(
            ["advisor_profile_id"], ["board_advisor_profiles.id"], ondelete="CASCADE"
        ),
    ...
    op.create_index(
        "ix_board_advisor_applications_project_id", "board_advisor_applications", ["project_id"]
    )
    op.create_index(
        "ix_board_advisor_applications_advisor_profile_id",
        "board_advisor_applications",
        ["advisor_profile_id"],
    )
    op.create_index(
        "ix_board_advisor_applications_ally_org_id", "board_advisor_applications", ["ally_org_id"]
    )
    op.create_index(
        "ix_board_advisor_applications_status", "board_advisor_applications", ["status"]
    )
    ...
    op.create_index(
        "ix_investor_personas_org_id_active", "investor_personas", ["org_id", "is_active"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "legal_automation_savings", sa.Numeric(19, 4), nullable=False, server_default="0"
        ),
        sa.Column("risk_analytics_savings", sa.Numeric(19, 4), nullable=False, server_default="0"),
        sa.Column(
            "tax_credit_value_captured", sa.Numeric(19, 4), nullable=False, server_default="0"
        ),
        ...
        sa.Column(
            "industry_avg_time_to_close", sa.Numeric(10, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "platform_efficiency_score", sa.Numeric(6, 2), nullable=False, server_default="0"
        ),
    ...
    op.create_index(
        "ix_capital_efficiency_metrics_org_id", "capital_efficiency_metrics", ["org_id"]
    )
    op.create_index(
        "ix_capital_efficiency_metrics_portfolio_id", "capital_efficiency_metrics", ["portfolio_id"]
    )
    op.create_index(
        "ix_capital_efficiency_metrics_period",
        "capital_efficiency_metrics",
    ...
    op.create_table(
        ...
        sa.Column(
            "severity",
            postgresql.ENUM(
                "info", "warning", "critical", name="monitoringalertseverity", create_type=False
            ),
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_index(
        "ix_investor_signal_scores_org_id_calculated",
        "investor_signal_scores",
