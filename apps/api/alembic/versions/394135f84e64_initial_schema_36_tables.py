...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "subscription_tier",
            sa.Enum("FOUNDATION", "PROFESSIONAL", "ENTERPRISE", name="subscriptiontier"),
            nullable=False,
        ),
        sa.Column(
            "subscription_status",
            sa.Enum("ACTIVE", "TRIAL", "SUSPENDED", "CANCELLED", name="subscriptionstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_investor_mandates_is_active", "investor_mandates", ["org_id", "is_active"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "strategy",
            sa.Enum(
                "IMPACT", "GROWTH", "INCOME", "BALANCED", "OPPORTUNISTIC", name="portfoliostrategy"
            ),
            nullable=False,
        ),
        sa.Column(
            "fund_type",
            sa.Enum("OPEN_END", "CLOSED_END", "EVERGREEN", "SPV", name="fundtype"),
            nullable=False,
        ),
        ...
        sa.Column(
            "sfdr_classification",
            sa.Enum(
                "ARTICLE_6", "ARTICLE_8", "ARTICLE_9", "NOT_APPLICABLE", name="sfdrclassification"
            ),
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_index(
        "ix_projects_geography_country", "projects", ["geography_country"], unique=False
    )
    ...
    op.create_index(
        "ix_activities_org_id_created_at", "activities", ["org_id", "created_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "context_type",
            sa.Enum("GENERAL", "PROJECT", "PORTFOLIO", "DATAROOM", "DEAL", name="aicontexttype"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_ai_conversations_context_type", "ai_conversations", ["context_type"], unique=False
    )
    op.create_index("ix_ai_conversations_org_id", "ai_conversations", ["org_id"], unique=False)
    op.create_index(
        "ix_ai_conversations_user_context",
        "ai_conversations",
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "PROCESSING", "COMPLETED", "FAILED", name="aitaskstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_ai_task_logs_entity", "ai_task_logs", ["entity_type", "entity_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("DRAFT", "REVIEW", "FINALIZED", name="businessplanstatus"),
            nullable=False,
        ),
        sa.Column("version", sa.Integer(), nullable=False),
        sa.Column("id", sa.UUID(), server_default=sa.text("gen_random_uuid()"), nullable=False),
    ...
    op.create_index(
        "ix_carbon_credits_verification_status",
        "carbon_credits",
        ["verification_status"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_document_folders_parent", "document_folders", ["parent_folder_id"], unique=False
    )
    op.create_index(
        "ix_document_folders_project_id", "document_folders", ["project_id"], unique=False
    )
    op.create_table(
        "generated_reports",
        sa.Column("org_id", sa.UUID(), nullable=False),
        ...
        sa.Column(
            "status",
            sa.Enum("QUEUED", "GENERATING", "READY", "ERROR", name="reportstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_generated_reports_org_id_status",
        "generated_reports",
        ["org_id", "status"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_generated_reports_template_id", "generated_reports", ["template_id"], unique=False
    )
    op.create_table(
        "legal_documents",
        sa.Column("org_id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        "ix_legal_documents_org_id_status", "legal_documents", ["org_id", "status"], unique=False
    )
    op.create_index(
        "ix_legal_documents_project_id", "legal_documents", ["project_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "listing_type",
            sa.Enum(
                "EQUITY_SALE", "DEBT_SALE", "CO_INVESTMENT", "CARBON_CREDIT", name="listingtype"
            ),
            nullable=False,
        ),
        sa.Column(
        ...
        sa.Column(
            "visibility",
            sa.Enum("PUBLIC", "QUALIFIED_ONLY", "INVITE_ONLY", name="listingvisibility"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "initiated_by",
            sa.Enum("SYSTEM", "INVESTOR", "ALLY", name="matchinitiator"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_match_results_ally_status", "match_results", ["ally_org_id", "status"], unique=False
    )
    op.create_index(
        "ix_match_results_investor_org_id", "match_results", ["investor_org_id"], unique=False
    )
    op.create_index(
        "ix_match_results_investor_status",
        "match_results",
        ["investor_org_id", "status"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum(
                "INFO", "WARNING", "ACTION_REQUIRED", "MENTION", "SYSTEM", name="notificationtype"
            ),
            nullable=False,
        ),
        sa.Column("title", sa.String(length=500), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "asset_type",
            sa.Enum("EQUITY", "DEBT", "MEZZANINE", "PREFERRED", "CONVERTIBLE", name="assettype"),
            nullable=False,
        ),
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "EXITED", "WRITTEN_OFF", "PENDING", name="holdingstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_portfolio_holdings_portfolio_id", "portfolio_holdings", ["portfolio_id"], unique=False
    )
    op.create_index(
        "ix_portfolio_holdings_portfolio_id_status",
        "portfolio_holdings",
        ["portfolio_id", "status"],
        unique=False,
    )
    op.create_index(
        "ix_portfolio_holdings_project_id", "portfolio_holdings", ["project_id"], unique=False
    )
    ...
    op.create_index(
        "ix_portfolio_metrics_as_of_date",
        "portfolio_metrics",
        ["portfolio_id", "as_of_date"],
        unique=False,
    )
    op.create_index(
        "ix_portfolio_metrics_portfolio_id", "portfolio_metrics", ["portfolio_id"], unique=False
    )
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PLANNED", "COMMITTED", "PAID", name="budgetitemstatus"),
            nullable=False,
        ),
        sa.Column("id", sa.UUID(), server_default=sa.text("gen_random_uuid()"), nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
    ...
    op.create_index(
        "ix_project_budget_items_project_id", "project_budget_items", ["project_id"], unique=False
    )
    op.create_table(
        "project_milestones",
        sa.Column("project_id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "entity_type",
            sa.Enum("PROJECT", "PORTFOLIO", "HOLDING", name="riskentitytype"),
            nullable=False,
        ),
        sa.Column("entity_id", sa.UUID(), nullable=False),
        sa.Column("org_id", sa.UUID(), nullable=False),
        ...
        sa.Column(
            "probability",
            sa.Enum("UNLIKELY", "POSSIBLE", "LIKELY", "VERY_LIKELY", name="riskprobability"),
            nullable=False,
        ),
        sa.Column("description", sa.Text(), nullable=False),
        ...
        sa.Column(
            "status",
            sa.Enum(
                "IDENTIFIED", "MONITORING", "MITIGATED", "ACCEPTED", name="riskassessmentstatus"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_risk_assessments_entity", "risk_assessments", ["entity_type", "entity_id"], unique=False
    )
    op.create_index("ix_risk_assessments_org_id", "risk_assessments", ["org_id"], unique=False)
    op.create_index(
        "ix_risk_assessments_risk_type", "risk_assessments", ["risk_type"], unique=False
    )
    ...
    op.create_index(
        "ix_scheduled_reports_is_active", "scheduled_reports", ["org_id", "is_active"], unique=False
    )
    op.create_index("ix_scheduled_reports_org_id", "scheduled_reports", ["org_id"], unique=False)
    op.create_index(
        "ix_scheduled_reports_template_id", "scheduled_reports", ["template_id"], unique=False
    )
    op.create_table(
        "signal_scores",
        sa.Column("project_id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        "ix_signal_scores_project_id_version",
        "signal_scores",
        ["project_id", "version"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "qualification",
            sa.Enum(
                "POTENTIAL", "QUALIFIED", "CLAIMED", "TRANSFERRED", name="taxcreditqualification"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("DRAFT", "REVIEWED", "APPROVED", "SUPERSEDED", name="valuationstatus"),
            nullable=False,
        ),
        sa.Column("version", sa.Integer(), nullable=False),
    ...
    op.create_index(
        "ix_valuations_project_id_version", "valuations", ["project_id", "version"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum(
                "USER", "ASSISTANT", "SYSTEM", "TOOL_CALL", "TOOL_RESULT", name="aimessagerole"
            ),
            nullable=False,
        ),
        sa.Column("content", sa.Text(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("UPLOADING", "PROCESSING", "READY", "ERROR", "ARCHIVED", name="documentstatus"),
            nullable=False,
        ),
        sa.Column("metadata", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "action",
            sa.Enum("VIEW", "DOWNLOAD", "SHARE", "PRINT", name="documentaccessaction"),
            nullable=False,
        ),
        sa.Column("ip_address", sa.String(length=45), nullable=True),
        sa.Column("timestamp", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
    ...
    op.create_index(
        "ix_document_access_logs_document_id", "document_access_logs", ["document_id"], unique=False
    )
    op.create_index(
        "ix_document_access_logs_org_id", "document_access_logs", ["org_id"], unique=False
    )
    op.create_index(
        "ix_document_access_logs_timestamp", "document_access_logs", ["timestamp"], unique=False
    )
    op.create_index(
        "ix_document_access_logs_user_id", "document_access_logs", ["user_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        "ix_document_extractions_document_id", "document_extractions", ["document_id"], unique=False
    )
    op.create_index(
        "ix_document_extractions_type", "document_extractions", ["extraction_type"], unique=False
    )
    op.create_table(
        "transactions",
        sa.Column("listing_id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        "ix_transactions_seller_org_id", "transactions", ["seller_org_id"], unique=False
    )
