...
def upgrade() -> None:
    ...
    op.create_index(
        ...
        "metric_snapshots",
        ["entity_type", "entity_id", "metric_name", "recorded_at"],
    )
    op.create_index(
        "ix_metric_snapshots_time_range", "metric_snapshots", ["metric_name", "recorded_at"]
    )
    ...
    op.create_index(
        "ix_benchmark_lookup",
        "benchmark_aggregates",
        ["asset_class", "geography", "metric_name", "period"],
    )
