...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_dd_checklist_templates_asset_type", "dd_checklist_templates", ["asset_type"]
    )
    op.create_index(
        "ix_dd_checklist_templates_deal_stage", "dd_checklist_templates", ["deal_stage"]
    )
    op.create_index(
        "ix_dd_template_type_stage", "dd_checklist_templates", ["asset_type", "deal_stage"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "template_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("dd_checklist_templates.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "template_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("dd_checklist_templates.id"),
            nullable=False,
        ),
        sa.Column(
            "investor_id",
    ...
    op.create_table(
        ...
        sa.Column(
            "checklist_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("dd_project_checklists.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "item_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("dd_checklist_items.id", ondelete="CASCADE"),
            nullable=False,
        ),
