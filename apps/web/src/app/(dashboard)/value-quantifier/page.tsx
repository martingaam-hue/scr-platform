...
const MOCK_VALUE_DATA = {
  ...
  total_investment: 420_000_000,
  jobs_created: 218,
  kpis: [
    { label: "Net IRR", value: "17.6%", quality: "excellent", description: "Net internal rate of return over 20-year hold period" },
    { label: "NPV", value: "€156M", quality: "excellent", description: "Net present value at 8% discount rate" },
    { label: "TVPI", value: "1.56x", quality: "excellent", description: "Total value to paid-in capital" },
    { label: "DPI", value: "0.12x", quality: "neutral", description: "Distributions to paid-in (operational since 2019)" },
    { label: "DSCR", value: "1.48", description: "Debt service coverage ratio (target ≥ 1.25)", quality: "good" },
    { label: "LCOE", value: "€42/MWh", description: "Levelised cost of energy — competitive vs market €68/MWh", quality: "excellent" },
    { label: "CO₂ Avoided", value: "98,000 t/yr", description: "Annual CO₂ equivalent avoided vs gas benchmark", quality: "excellent" },
    { label: "Payback Period", value: "6.2 years", description: "Simple payback on equity investment", quality: "good" },
  ] as ValueKPI[],
  assumptions: {
    discount_rate: "8.0%",
    electricity_price_kwh: "€0.092",
    project_lifetime_years: 40,
    debt_ratio: "68%",
    interest_rate: "3.8%",
    capacity_mw: 35,
    annual_yield_gwh: 142,
  },
};
