...
const MOCK_TAX_CREDITS = [
  {
    id: "tc-001",
    project: "Helios Solar Portfolio Iberia",
    credit: "EU Green Deal Tax Incentive",
    ...
    certified: "Feb 28, 2026",
    score_impact: "+3.8 pts",
    docs_required: 4,
    docs_submitted: 4,
  },
  {
    id: "tc-002",
    project: "Nordic Biomass Energy",
    credit: "Swedish Bioenergy Tax Relief",
    program: "Swedish Energy Agency",
    jurisdiction: "Sweden",
    ...
    submitted: null,
    certified: null,
    score_impact: "+1.4 pts",
    docs_required: 3,
    docs_submitted: 0,
  },
  {
    id: "tc-003",
    project: "Thames Clean Energy Hub",
    credit: "UK Contracts for Difference Support",
    program: "UK DESNZ",
    ...
    certified: null,
    score_impact: "+2.9 pts",
    docs_required: 5,
    docs_submitted: 5,
  },
  {
    id: "tc-004",
    project: "Alpine Hydro Partners",
    credit: "Swiss Federal Energy Credit",
    program: "Swiss Federal Office of Energy",
    jurisdiction: "Switzerland",
    status: "certified" as const,
    value: 680_000,
    currency: "CHF",
    submitted: "Oct 14, 2025",
    certified: "Nov 20, 2025",
  ...
  {
    id: "tc-005",
    project: "Nordvik Wind Farm II",
    credit: "Norwegian Enova Grant",
    program: "Enova SF",
    jurisdiction: "Norway",
...
const MOCK_APPLICATIONS = MOCK_TAX_CREDITS.map((tc) => ({
  id: tc.id,
  project: tc.project,
  credit: tc.credit,
  program: tc.program,
  status: (tc.status === "eligible" ? "draft" : tc.status) as AppStatus,
  value: tc.value,
  submitted: tc.submitted,
  certified: tc.certified,
  score_impact: tc.score_impact,
  docs_required: tc.docs_required,
  docs_submitted: tc.docs_submitted,
}));
